...
Данная опция определяет, раз в сколько тиков сервер будет пытаться заспавнить моба.
